...
User-Principal-Name. Using AD FS introduces a dependency on the Perl package Crypt::JWT to
decode and validate the attribute assertions (Download with your favorite package manager).
...
=== Microsoft Azure ID / Entra

Using Microsoft Azure AD / Entra introduces a dependency on the Perl package Crypt::JWT to
decode and validate the attribute assertions (Download with your favorite package manager).
